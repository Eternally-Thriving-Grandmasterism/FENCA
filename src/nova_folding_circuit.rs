// src/nova_folding_circuit.rs
// FENCA-Pinnacle — Nova Uniform Folding Circuit Stub in Halo2 v1.0
...
/// Nova uniform folding stub: fold left/right instances
#[derive(Clone)]
struct NovaFoldingCircuit {
    left_instance: Value<Fp>,
    right_instance: Value<Fp>,
    challenge: Value<Fp>,
}

impl Circuit<Fp> for NovaFoldingCircuit {
    type Config = ();
...
#[pyfunction]
fn nova_fold_prove(left_hex: String, right_hex: String, challenge_hex: String) -> PyResult<String> {
...
#[pyfunction]
fn nova_fold_verify(proof: String, folded_instance_hex: String) -> PyResult<bool> {
